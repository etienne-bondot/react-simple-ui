      ...
      <Article>
        ...
        >
          {sections.map((s, i) => (
            <li key={i}>
              <Link
                to={`${props.location.pathname}#${s.title
                  .split(" ")
                  .join("-")
                  .toLowerCase()}`}
              >
          ...
          {properties && (
            <li>
              <Link to={`${props.location.pathname}#properties`}>
                Properties
              </Link>
            </li>
          )}
        ...
        {sections.map((s, i) => (
          <Fragment key={i}>
            ...
            <ArticleContent>
              {s.desc && typeof s.desc === "object" ? (
                s.desc
              ) : s.desc && typeof s.desc === "string" ? (
                <p>{s.desc}</p>
              ) : null}
              {s.children}
            </ArticleContent>
                ...
                <tbody>
                  {properties.map((property, i) => (
                    <tr key={i}>
                      <td>{property.name}</td>
                      <td>
                        <span className="Red">{property.type}</span>
                      </td>
                      <td>{property.desc}</td>
                    </tr>
                  ))}
