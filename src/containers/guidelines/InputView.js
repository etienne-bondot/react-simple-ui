    ...
    sections: [
      {
        ...
        desc: (
          <p>
            The <strong>Input</strong> component is a styled component. It
            contains a state to handle change and every properties an input can
            usually takes.
          </p>
        ),
        children: (
          ...
          >
            ...
            <Input
              type="text"
              name="patternField"
              placeholder="Validate three letters"
              pattern="[A-Za-z]{3}"
            />
